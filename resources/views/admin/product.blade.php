                    ...
                    <div class="div_center">
                        ...
                        <form action="{{ url('/add_product') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="dev_design">
                                ...
                                <input class="text-color" type="text" name="title" required>
                            </div>
                            <div class="dev_design">
                                <label for="title">Product Description: </label>
                                <input class="text-color" type="text" name="description" required>
                            </div>

                            <div class="dev_design">
                                <label for="title">Product Quantity: </label>
                                <input class="text-color" type="number" name="quantity" required>
                            </div>
                            <div class="dev_design">
                                <label for="title">Product Price: </label>
                                <input class="text-color" typ" name="price" required>
                            </div>
                            <div class="dev_design">
